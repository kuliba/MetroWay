...
{
    [self showMenuViewController:self];
}
...
MWMenuViewController *menuViewController;
MWSearchStationViewController *searchStationViewController;
MWSelectLanguageViewController *selectLanguageViewController;
MWSelectMapViewController *selectMapViewController;
MWSelectSortViewController *selectSortViewController;
MWStationListViewController *stationListViewController;

- (void)showMenuViewController:(UIViewController *)viewController
{
    UIViewController *vc = viewController ? viewController : self;
    menuViewController = [[MWMenuViewController alloc] init];
    [vc presentViewController:menuViewController animated:YES completion:nil];
}
...
{
    UIViewController *vc = viewController ? viewController : self;
    searchStationViewController = [[MWSearchStationViewController alloc] init];
    ...
    [vc presentViewController:searchStationViewController animated:YES completion:nil];
}

- (void)hideSearchStationViewController
{
    if (searchStationViewController) {
        [searchStationViewController dismissViewControllerAnimated:YES completion:nil];
    }
}
...
{
    UIViewController *vc = viewController ? viewController : self;
    selectLanguageViewController = [[MWSelectLanguageViewController alloc] init];
    [vc presentViewController:selectLanguageViewController animated:YES completion:nil];
}

- (void)hideSelectLanguageViewController
{
    if (selectLanguageViewController) {
        [selectLanguageViewController dismissViewControllerAnimated:YES completion:nil];
    }
}
...
{
    UIViewController *vc = viewController ? viewController : self;
    selectMapViewController = [[MWSelectMapViewController alloc] init];
    [vc presentViewController:selectMapViewController animated:YES completion:nil];
}

- (void)hideSelectMapViewController
{
    if (selectMapViewController) {
            [selectMapViewController dismissViewControllerAnimated:YES completion:nil];
    }
}
...
{
    UIViewController *vc = viewController ? viewController : self;
    selectSortViewController = [[MWSelectSortViewController alloc] init];
    [vc presentViewController:selectSortViewController animated:YES completion:nil];
}

- (void)hideSelectSortViewController
{
    if (selectSortViewController) {
        [selectSortViewController dismissViewControllerAnimated:YES completion:nil];
    }
}
...
{
    UIViewController *vc = viewController ? viewController : self;
    stationListViewController = [[MWStationListViewController alloc] init];
    stationListViewController.is_From = for_From;
    [vc presentViewController:stationListViewController animated:YES completion:nil];
}

- (void)hideStationListViewController
{
    if (stationListViewController) {
        [stationListViewController dismissViewControllerAnimated:YES completion:nil];
    }
}
