...
- (id)init
{
    ...
    vertex0001.developmentName = @"Вершина: Тропарево";
 ...
 */
    ...
    // Создаем участок линии от "Тропарево" до "Парк культуры"
    ////////////////////////////////////////////////////////////////
    ...
    drawLine0385.startPoint = CGPointMake(630, 2645.5);
    ...
    drawTextLine0386.origin = CGPointMake(675, 2730);
